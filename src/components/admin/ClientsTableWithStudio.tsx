/**
 * ClientsTableWithStudio - Tabla de clientes con studioId explícito
 *
 * Versión del ClientsTable que acepta studioId y schemaName como props
 * para usar en /admin/my-studios/[studioId]/clients
 */
...
import { Search, Pencil, Trash2, FileText, Download, RefreshCw } from 'lucide-react'
...
export function ClientsTableWithStudio({ studioId, schemaName }: Props) {
                  ...
                  <TableCell>
                    <div className="flex gap-1">
                      <Button variant="ghost" size="icon" asChild>
                        <a href={`/admin/my-studios/${studioId}/clients/${client.id}`}>
                          <Pencil className="h-4 w-4" />
                        </a>
                      </Button>
                      <Button variant="ghost" size="icon" className="text-blue-600 hover:text-blue-700 hover:bg-blue-50" asChild>
                        <a href={`/admin/my-studios/${studioId}/clients/${client.id}/transactions`}>
